...
ball2 = sphere(pos=vec(-L/2, 0, 0), radius=size, texture=textures.wood, make_trail=True, v=vec((math.cos(angle)*v), (math.sin(angle)*v), 0), a=vec(0, g, 0))
